...
def request_body_variable_mapper(
    query: dict,
    apply_request_body_variable_mapping: [dict, None],
    locals: dict,
    create_one=True,
) -> dict:
    if not apply_request_body_variable_mapping:
        return query
    for key, value in apply_request_body_variable_mapping.items():
        eval_value = eval(value, globals(), locals)
        if create_one:
    ...
    def find_one(
        ...
        *,
        ...
        if not async_mode:
            ...
            async def async_get_one_by_primary_key(
                response: Response,
                request: Request,
                url_param=Depends(request_url_param_model),
                query=Depends(request_query_model),
        ...
        *,
        ...
        if async_mode:
            ...
            async def async_insert_one(
                ...
                new_inserted_data = query_service.create(insert_arg=query_dict)
                ...
                try:
                    ...
                    return result
                return await parsing_service.async_create_one(
                    response_model=response_model,
            ...
            def insert_one(
                ...
                try:
                    ...
                    result = Response(status_code=HTTPStatus.CONFLICT)
                    return result
                return parsing_service.create_one(
                    response_model=response_model,
                    sql_execute_result=new_inserted_data,
                    fastapi_response=response,
                    session=session,
        ...
        *,
        ...
        if async_mode:
            ...
            async def async_insert_many(
                ...
                inserted_data = query_service.create(
                    insert_arg=query_dict, create_one=False
                )
                ...
                try:
                    ...
                    result = Response(status_code=HTTPStatus.CONFLICT)
                    return result
                return await parsing_service.async_create_many(
                    response_model=response_model,
            ...
            def insert_many(
                ...
                try:
                    ...
                    result = Response(status_code=HTTPStatus.CONFLICT)
                    return result
                return parsing_service.create_many(
                    response_model=response_model,
                    sql_execute_result=inserted_data,
                    fastapi_response=response,
                    session=session,
    ...
    def delete_one(
        ...
        *,
        ...
        if async_mode:
            ...
            async def async_delete_one_by_primary_key(
                response: Response,
                request: Request,
                query=Depends(request_query_model),
                ...
                #     session=session)
                filter_stmt = query_service.model_query(
                    filter_args=request_url_param_model.__dict__,
                    extra_args=query.__dict__,
                    session=session,
                )
            ...
            def delete_one_by_primary_key(
                ...
                return parsing_service.delete_one(
                    response_model=response_model,
                    sql_execute_result=delete_instance,
                    fastapi_response=response,
                    session=session,
    ...
    def delete_many(
        ...
        *,
        ...
        if async_mode:
            ...
            async def async_delete_many_by_query(
                response: Response,
                request: Request,
                query=Depends(request_query_model),
                session=Depends(db_session),
                ...
                filter_stmt = query_service.model_query(
                    filter_args=query.__dict__, session=session
                )
            ...
            def delete_many_by_query(
                ...
                return parsing_service.delete_many(
                    response_model=response_model,
    ...
    def post_redirect_get(
        ...
        *,
        ...
        if async_mode:
            ...
            @api.post(
                "", status_code=303, response_class=Response, dependencies=dependencies
            )
            async def async_create_one_and_redirect_to_get_one_api_with_primary_key(
                ...
                query_dict = request_body_variable_mapper(
                    insert_args.__dict__, request_body_variable_mapping, locals()
                )
                new_inserted_data = crud_service.insert_one(insert_args=query_dict)
            ...
            def create_one_and_redirect_to_get_one_api_with_primary_key(
                ...
                return result_parser.post_redirect_get(
                    response_model=response_model,
                    sql_execute_result=new_inserted_data,
                    fastapi_request=request,
                    session=session,
        ...
        *,
        ...
        if async_mode:
            ...
            async def async_partial_update_one_by_primary_key(
                ...
                filter_stmt = crud_service.model_query(
                ...
                try:
                    return await result_parser.async_update(
                        response_model=response_model,
        ...
        *,
        ...
        if async_mode:
            ...
            async def async_partial_update_many_by_query(
                ...
                filter_stmt = crud_service.model_query(
                    filter_args=extra_query.__dict__, session=session
                )
    ...
    def find_one_foreign_tree(
        ...
        *,
        ...
        if async_mode:
            ...
            async def async_get_one_with_foreign_tree(
                response: Response,
                request: Request,
                url_param=Depends(request_url_param_model),
                query=Depends(request_query_model),
                ...
                join = query.__dict__.pop("join_foreign_table", None)
                stmt = query_service.get_one_with_foreign_pk(
                ...
                parsed_response = await parsing_service.async_find_one(
                    response_model=response_model,
                    sql_execute_result=query_result,
                    fastapi_response=response,
                    join_mode=join,
            ...
            def get_one_with_foreign_tree(
                ...
                query_result = execute_service.execute(session, stmt)
                parsed_response = parsing_service.find_one(
                    response_model=response_model,
                    sql_execute_result=query_result,
                    fastapi_response=response,
                    join_mode=join,
    ...
    def find_many_foreign_tree(
        ...
        *,
        ...
        if async_mode:
            ...
            async def async_get_many_with_foreign_tree(
                response: Response,
                request: Request,
                url_param=Depends(request_url_param_model),
                query=Depends(request_query_model),
            ...
            def get_many_with_foreign_tree(
                response: Response,
                request: Request,
                url_param=Depends(request_url_param_model),
                query=Depends(request_query_model),
        ...
        *,
        ...
        if async_mode:
            ...
            async def async_insert_one_and_support_upsert(
                ...
                stmt = query_service.upsert(
                    insert_arg=query.__dict__, unique_fields=unique_list
                )
            ...
            def insert_one_and_support_upsert(
                ...
                try:
                    ...
                    result = Response(status_code=HTTPStatus.CONFLICT, content=err_msg)
                    return result
                return parsing_service.upsert_one(
                    response_model=response_model,
                    sql_execute_result=query_result,
                    fastapi_response=response,
                    session=session,
        ...
        if async_mode:
            ...
            def insert_many_and_support_upsert(
                ...
                try:
                    ...
                    result = Response(status_code=HTTPStatus.CONFLICT, content=err_msg)
                    return result
                return parsing_service.upsert_many(
                    response_model=response_model,
                    sql_execute_result=query_result,
                    fastapi_response=response,
                    session=session,
